...
//            self.trackingView.rectToPlate = self.visionProcessor.rectToPlate
            self.trackingView.plateDetectRes = self.visionProcessor.plateDetectRes
            self.trackingView.videoWidth = self.visionProcessor.videoWidth
            self.trackingView.videoHeight = self.visionProcessor.videoHeight
            self.trackingView.goalCar = self.goalCar
            self.trackingView.visionProcessor = self.visionProcessor
//            self.trackingView.syntesizer = self.syntesizer
//            print(detectTrackUUID)
            print("++++++++++++++++++++跨页面传递+++++++++++++++++++++++++")
